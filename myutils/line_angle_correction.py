...
def crop(img, points, debug=False, rotate=True, extend=True,
...
def rotate_and_crop(img, points, debug=False, rotate=True, extend=True,
    ...
    h, w, c = warped.shape
    rotate_warped = cv2.rotate(warped, cv2.ROTATE_180)
    if w < h and rotate:
...
if __name__ == '__main__':
    ...
    #                 [[232, 108]],
    #                 [[469, 109]]])
    path_im = r'C:\Users\thinhtu1203\Desktop\aip391-kie\data\data_for_experiments\preprocess-sample\mcocr_public_145013rhwvu.jpg'
