...
import time
from myutils.visualize import viz_output_of_pick
from create_train_data.create_train_data import create_data_pick_boxes_and_transcripts
from config import cls_out_txt_dir, kie_boxes_transcripts, kie_model, \
    inference_rotated_img_dir, inference_pick_out_txt_dir, kie_out_viz_dir, \
    gpu, kie_visualize, inference_pick_out_viz_dir
...
def main(args):
    ...
    if kie_visualize:
        viz_output_of_pick(img_dir=inference_rotated_img_dir,
                           output_txt_dir=inference_pick_out_txt_dir,
                           output_viz_dir=inference_pick_out_viz_dir)
...
if __name__ == '__main__':
    ...
    args.add_argument('--impt', '--images_path', default=inference_rotated_img_dir, type=str,
                      help='images folder path (default: None)')
    args.add_argument('-output', '--output_folder', default=inference_pick_out_txt_dir, type=str,
