...
import os, time, cv2
from mc_ocr.utils.common import get_file_list_from_dir_and_subdirs

from vietocr.vietocr.tool.predictor import Predictor
from vietocr.vietocr.tool.config import Cfg
from config import cls_base_config_path, cls_config_path, cls_model_path
...
def test_inference():
    ...
    img_path = ''
    if img_path == '':
        list_files = get_file_list_from_dir_and_subdirs(src_dir)
